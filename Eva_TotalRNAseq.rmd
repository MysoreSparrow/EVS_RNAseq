---
title: "Eva_RNAseq - day7 spF vs adult spF"
...
color_values <- c(
  "red", "red", "red", "black", "black", "black", "red", "red", "red", "red", "red",
...
ggsave(
  filename = file.path(adult_spfVsd7_spf_path, "/Vol1_L2fcVsPvalue.png"),
  plot = volcano1,
  dpi = 300,
  width = 5,
  height = 5,
...
ggsave(
  filename = file.path(adult_spfVsd7_spf_path, "/Vol2_L2fcVsPadj.png"),
  plot = volcano2,
  dpi = 300,
  width = 10,
  height = 10,
...
```{r}
# mat <- counts(dds2, normalized = TRUE)[rownames(sigsdf),]
mat <- counts(dds, normalized = TRUE)[(sigsdf$symbol), ]
...
```{r}
mat2 <- counts(dds, normalized = TRUE)[(sigsdf$symbol), ]
...
```
```{r}
# write.csv(mat2.zs, Eva_project_path)
```
