...
Comparison_Path <- d7_GFVsd7_spF_path
...
Comparison <- "Day7 GermFree VS Day7 spF"
...
res <- results(dds1, contrast = c("MouseType", "SPF", "GF"))
...
```{r}
sigs1df <- resdf[(resdf$baseMean > 500) & (abs(resdf$log2FoldChange) > 2) & (resdf$pvalue < 0.05), ]
